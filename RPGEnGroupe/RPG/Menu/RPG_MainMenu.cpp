...
{
	logoTitle = new RPG_Image(owner, "../Donnees/Title2.png");
	logoTitle->SetPosition(sf::Vector2f((WIDTH / 2) - 30, 150));
	logoTitle->SetScale(sf::Vector2f(0.8f, 0.8f));
...
void RPG_MainMenu::InitPlayButton()
{
	...
	const sf::Vector2f _position = sf::Vector2f((WIDTH / 2) - 30, HEIGHT - 100);
